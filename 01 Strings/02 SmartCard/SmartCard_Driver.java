...
public class SmartCard_Driver
{
   public static void main(String[] args) 
   {
      ...
      SmartCard dummy = new SmartCard(5.00);
      dummy.board(suburbia);
      dummy.exit(suburbia);
      System.out.println("getIsBoarded() "+ dummy.getIsBoarded());
      System.out.println("getBoardedAt() "+ dummy.getBoardedAt());
      dummy.addMoney(425.47);
